...
const routes = [
	...
	// 个人用户路由
	{
		path: '/individual_users/table',
		name: 'individual_users_table',
		component: () => import('../views/individual_users/table.vue')
	},
	{
		path: '/individual_users/view',
		name: 'individual_users_view',
		component: () => import('../views/individual_users/view.vue')
	},
	// 企业用户路由
	{
	...
	// 个人简历路由
	{
		path: '/curriculum_vitae/table',
		name: 'curriculum_vitae_table',
		component: () => import('../views/curriculum_vitae/table.vue')
	},
	{
		path: '/curriculum_vitae/view',
		name: 'curriculum_vitae_view',
		component: () => import('../views/curriculum_vitae/view.vue')
	},
