	...
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/user/table" v-show="user_group == '管理员'"><span>管理员</span></el-menu-item>
						<el-menu-item index="/individual_users/table" v-show="user_group == '管理员' || $check_action('/individual_users/table')"><span>个人用户</span></el-menu-item>
							<el-menu-item index="/enterprise_users/table" v-show="user_group == '管理员' || $check_action('/enterprise_users/table')"><span>企业用户</span></el-menu-item>
