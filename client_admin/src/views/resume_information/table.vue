		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/resume_information/table','add') || $check_action('/resume_information/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/resume_information/table','del') || $check_action('/resume_information/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','contact_information')" min-width="200">
					...
					<el-table-column prop="enterprise_information" @sort-change="$sortChange" label="企业信息"
				v-if="user_group == '管理员' || $check_field('get','enterprise_information')" min-width="200">
						<template slot-scope="scope">
					{{ get_user_enterprise_information(scope.row['enterprise_information']) }}
				</template>
					</el-table-column>
				...
				v-if="user_group == '管理员' || $check_field('get','enterprise_name')" min-width="200">
					...
					<el-table-column prop="recruitment_position" @sort-change="$sortChange" label="招聘岗位"
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/resume_information/table','set') || $check_action('/resume_information/view','set') || $check_action('/resume_information/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
