	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="用户信息" prop="user_information">
							...
							<!--v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','user_information')) || (!form['curriculum_vitae_id'] && $check_field('add','user_information'))" :disabled="disabledObj['user_information_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','user_information')">{{form['user_information']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','user_information')) || (!form['curriculum_vitae_id'] && $check_field('add','user_information'))" id="user_information" v-model="form['user_information']" :disabled="disabledObj['user_information_isDisabled']">
				...
				<el-form-item label="用户姓名" prop="user_name">
							  ...
							  v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','user_name')) || (!form['curriculum_vitae_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']"></el-input>
				...
				<el-form-item label="用户年龄" prop="user_age">
							  ...
							  v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','user_age')) || (!form['curriculum_vitae_id'] && $check_field('add','user_age'))" :disabled="disabledObj['user_age_isDisabled']"></el-input>
				...
				<el-form-item label="毕业学院" prop="graduation_college">
							  ...
							  v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','graduation_college')) || (!form['curriculum_vitae_id'] && $check_field('add','graduation_college'))" :disabled="disabledObj['graduation_college_isDisabled']"></el-input>
				...
				<el-form-item label="个人特长" prop="personal_specialty">
							  ...
							  v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','personal_specialty')) || (!form['curriculum_vitae_id'] && $check_field('add','personal_specialty'))" :disabled="disabledObj['personal_specialty_isDisabled']"></el-input>
				...
				<el-form-item label="联系方式" prop="contact_information">
							  ...
							  v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','contact_information')) || (!form['curriculum_vitae_id'] && $check_field('add','contact_information'))" :disabled="disabledObj['contact_information_isDisabled']"></el-input>
				...
				<el-form-item label="求职岗位" prop="job_position">
							  ...
							  v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','job_position')) || (!form['curriculum_vitae_id'] && $check_field('add','job_position'))" :disabled="disabledObj['job_position_isDisabled']"></el-input>
				...
				<el-form-item label="工作经历" prop="work_experience">
						...
						v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','work_experience')) || (!form['curriculum_vitae_id'] && $check_field('add','work_experience'))" :disabled="disabledObj['work_experience_isDisabled']"></el-input>
				...
				<el-form-item label="个人简历" prop="curriculum_vitae">
						...
						:show-file-list="false" v-if="user_group === '管理员' || (form['curriculum_vitae_id'] && $check_field('set','curriculum_vitae')) || (!form['curriculum_vitae_id'] && $check_field('add','curriculum_vitae'))">
