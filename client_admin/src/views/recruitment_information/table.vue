		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','recruitment_position')" min-width="200">
					...
					<el-table-column prop="number_of_recruiters" @sort-change="$sortChange" label="招聘人数"
				v-if="user_group == '管理员' || $check_field('get','number_of_recruiters')" min-width="200">
					</el-table-column>
					<el-table-column prop="office_location" @sort-change="$sortChange" label="办公地点"
				v-if="user_group == '管理员' || $check_field('get','office_location')" min-width="200">
					</el-table-column>
					<el-table-column prop="salary_range" @sort-change="$sortChange" label="薪资范围"
				v-if="user_group == '管理员' || $check_field('get','salary_range')" min-width="200">
					</el-table-column>
				...
				v-if="user_group == '管理员' || $check_field('get','job_requirements')" min-width="200">
					...
					<el-table-column prop="enterprise_cover" @sort-change="$sortChange" label="企业封面"
				v-if="user_group == '管理员' || $check_field('get','enterprise_cover')" min-width="200">
						<template slot-scope="scope">
					<el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['enterprise_cover'])"
						:preview-src-list="[$fullUrl(scope.row['enterprise_cover'])]">
