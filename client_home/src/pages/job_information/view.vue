          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','user_information') || $check_field('add','user_information') || $check_field('set','user_information')" label="用户信息" name="user_information">
                  ...
                  v-if="user_group === '管理员' || (form['job_information_id'] && $check_field('set','user_information')) || (!form['job_information_id'] && $check_field('add','user_information'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['user_information']"
                  :localdata="list_user_user_information"
              ...
              <uni-forms-item v-if="$check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" label="用户姓名" name="user_name">
                                <uni-easyinput type="text" v-model="form['user_name']" v-if="user_group === '管理员' || (form['job_information_id'] && $check_field('set','user_name')) || (!form['job_information_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_age') || $check_field('add','user_age') || $check_field('set','user_age')" label="用户年龄" name="user_age">
                                <uni-easyinput type="text" v-model="form['user_age']" v-if="user_group === '管理员' || (form['job_information_id'] && $check_field('set','user_age')) || (!form['job_information_id'] && $check_field('add','user_age'))" :disabled="disabledObj['user_age_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','graduation_college') || $check_field('add','graduation_college') || $check_field('set','graduation_college')" label="毕业学院" name="graduation_college">
                                <uni-easyinput type="text" v-model="form['graduation_college']" v-if="user_group === '管理员' || (form['job_information_id'] && $check_field('set','graduation_college')) || (!form['job_information_id'] && $check_field('add','graduation_college'))" :disabled="disabledObj['graduation_college_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','personal_specialty') || $check_field('add','personal_specialty') || $check_field('set','personal_specialty')" label="个人特长" name="personal_specialty">
                                <uni-easyinput type="text" v-model="form['personal_specialty']" v-if="user_group === '管理员' || (form['job_information_id'] && $check_field('set','personal_specialty')) || (!form['job_information_id'] && $check_field('add','personal_specialty'))" :disabled="disabledObj['personal_specialty_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','contact_information') || $check_field('add','contact_information') || $check_field('set','contact_information')" label="联系方式" name="contact_information">
                                <uni-easyinput type="text" v-model="form['contact_information']" v-if="user_group === '管理员' || (form['job_information_id'] && $check_field('set','contact_information')) || (!form['job_information_id'] && $check_field('add','contact_information'))" :disabled="disabledObj['contact_information_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','job_position') || $check_field('add','job_position') || $check_field('set','job_position')" label="求职岗位" name="job_position">
                                <uni-easyinput type="text" v-model="form['job_position']" v-if="user_group === '管理员' || (form['job_information_id'] && $check_field('set','job_position')) || (!form['job_information_id'] && $check_field('add','job_position'))" :disabled="disabledObj['job_position_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','work_experience') || $check_field('add','work_experience') || $check_field('set','work_experience')" label="工作经历" name="work_experience">
                        <uni-easyinput type="textarea" v-model="form['work_experience']" v-if="user_group === '管理员' || (form['job_information_id'] && $check_field('set','work_experience')) || (!form['job_information_id'] && $check_field('add','work_experience'))" :disabled="disabledObj['work_experience_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','work_experience')">
                  {{ form['work_experience'] }}
                </text>
                    </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','personal_photos') || $check_field('add','personal_photos') || $check_field('set','personal_photos')" label="个人照片" name="personal_photos">
                        <!-- 修改权限 -->
                <view class="diy_field diy_img" v-if="form['personal_photos'] && $check_field('set','personal_photos')">
                  <image v-if="disabledObj['personal_photos_isDisabled']" :src="$fullUrl(form['personal_photos'])" />
                  <image v-if="!disabledObj['personal_photos_isDisabled']" :src="$fullUrl(form['personal_photos'])" @click="change_img('personal_photos')" />
                </view>
                <!-- 添加权限 -->
                <view class="diy_field diy_img" v-else-if="!form['personal_photos'] && $check_field('add','personal_photos')">
                  <view v-if="disabledObj['personal_photos_isDisabled']" class="btn_add_img">
                    <text>+</text>
                  </view>
                  <view v-if="!disabledObj['personal_photos_isDisabled']" class="btn_add_img" @click="change_img('personal_photos')">
                    <text>+</text>
                  </view>
                </view>
                <!-- 查询权限 -->
                <view class="diy_field diy_img" v-else-if="$check_field('get','personal_photos')">
                  <image :src="$fullUrl(form['personal_photos'])" />
                </view>
                    </uni-forms-item>
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/job_information/upload?'),
