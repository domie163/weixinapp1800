<template>
  <view class="page_resume_information diy_table diy_table_tml" id="resume_information_table">
    <!-- 筛选模块(开始) -->
    <view>
              ...
              <uni-forms :modelValue="query">
                    <uni-forms-item label="用户姓名" name="user_name">
                      <uni-easyinput type="text" v-model="query.user_name" placeholder="用户姓名" />
                        ...
                        <uni-forms-item label="个人学历" name="personal_education">
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/resume_information/view?" v-show="user_group == '管理员' || $check_action('/resume_information/table','add') || $check_action('/resume_information/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','user_information')" class="col">
						<view class="view">
                            ...
                            <span>用户年龄</span>
								...
								<text>
									{{ o["user_age"] }}
													...
													<view v-if="1 && $check_field('get','personal_education')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>个人学历</span>
                          </view>
                            ...
                            <span>联系方式</span>
								...
								<text>
									{{ o["contact_information"] }}
													...
													<view v-if="0 && $check_field('get','enterprise_information')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>企业信息</span>
                          </view>
								...
								<text>
									{{ get_user_enterprise_information(o['enterprise_information']) }}
													...
													<view v-if="0 && $check_field('get','enterprise_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>企业名称</span>
                          </view>
								...
								<text>
									{{ o["enterprise_name"] }}
													...
													<view v-if="1 && $check_field('get','recruitment_position')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>招聘岗位</span>
                          </view>
								...
								<text>
									{{ o["recruitment_position"] }}
													...
													<view v-if="1 && $check_field('get','curriculum_vitae')" class="col">
						<view class="view">
                          <view class="diy_title" v-if=" false">
                            <span>个人简历</span>
                          </view>
											<view class="diy_field diy_img">
								<img :src="$fullUrl(o['curriculum_vitae'])" />
							</view>
										</view>
					</view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/resume_information/table','del') || $check_action('/resume_information/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/resume_information/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/resume_information/table','set') || $check_action('/resume_information/view','set') || $check_action('/resume_information/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
		...
		data() {
			return {
                ...
                list_user_gender: [{value:"",text:"全部"}],
                                    // 个人学历列表
                list_personal_education: [{value:"",text:"全部"}],
                                                // 用户列表
