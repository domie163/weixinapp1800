          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','user_information') || $check_field('add','user_information') || $check_field('set','user_information')" label="用户信息" name="user_information">
                  ...
                  v-if="user_group === '管理员' || (form['resume_information_id'] && $check_field('set','user_information')) || (!form['resume_information_id'] && $check_field('add','user_information'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['user_information']"
                  :localdata="list_user_user_information"
              ...
              <uni-forms-item v-if="$check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" label="用户姓名" name="user_name">
                                <uni-easyinput type="text" v-model="form['user_name']" v-if="user_group === '管理员' || (form['resume_information_id'] && $check_field('set','user_name')) || (!form['resume_information_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_age') || $check_field('add','user_age') || $check_field('set','user_age')" label="用户年龄" name="user_age">
                                <uni-easyinput type="text" v-model="form['user_age']" v-if="user_group === '管理员' || (form['resume_information_id'] && $check_field('set','user_age')) || (!form['resume_information_id'] && $check_field('add','user_age'))" :disabled="disabledObj['user_age_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','contact_information') || $check_field('add','contact_information') || $check_field('set','contact_information')" label="联系方式" name="contact_information">
                                <uni-easyinput type="text" v-model="form['contact_information']" v-if="user_group === '管理员' || (form['resume_information_id'] && $check_field('set','contact_information')) || (!form['resume_information_id'] && $check_field('add','contact_information'))" :disabled="disabledObj['contact_information_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','enterprise_information') || $check_field('add','enterprise_information') || $check_field('set','enterprise_information')" label="企业信息" name="enterprise_information">
                  ...
                  v-if="user_group === '管理员' || (form['resume_information_id'] && $check_field('set','enterprise_information')) || (!form['resume_information_id'] && $check_field('add','enterprise_information'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['enterprise_information']"
                  :localdata="list_user_enterprise_information"
              ...
              <uni-forms-item v-if="$check_field('get','enterprise_name') || $check_field('add','enterprise_name') || $check_field('set','enterprise_name')" label="企业名称" name="enterprise_name">
                                <uni-easyinput type="text" v-model="form['enterprise_name']" v-if="user_group === '管理员' || (form['resume_information_id'] && $check_field('set','enterprise_name')) || (!form['resume_information_id'] && $check_field('add','enterprise_name'))" :disabled="disabledObj['enterprise_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','recruitment_position') || $check_field('add','recruitment_position') || $check_field('set','recruitment_position')" label="招聘岗位" name="recruitment_position">
                                <uni-easyinput type="text" v-model="form['recruitment_position']" v-if="user_group === '管理员' || (form['resume_information_id'] && $check_field('set','recruitment_position')) || (!form['resume_information_id'] && $check_field('add','recruitment_position'))" :disabled="disabledObj['recruitment_position_isDisabled']" />
                <!-- 仅查看 -->
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/resume_information/upload?'),
