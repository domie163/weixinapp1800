          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','enterprise_name') || $check_field('add','enterprise_name') || $check_field('set','enterprise_name')" label="企业名称" name="enterprise_name">
                                <uni-easyinput type="text" v-model="form['enterprise_name']" v-if="user_group === '管理员' || (form['enterprise_users_id'] && $check_field('set','enterprise_name')) || (!form['enterprise_users_id'] && $check_field('add','enterprise_name'))" :disabled="disabledObj['enterprise_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" label="用户姓名" name="user_name">
                                <uni-easyinput type="text" v-model="form['user_name']" v-if="user_group === '管理员' || (form['enterprise_users_id'] && $check_field('set','user_name')) || (!form['enterprise_users_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_gender') || $check_field('add','user_gender') || $check_field('set','user_gender')" label="用户性别" name="user_gender">
                  ...
                  v-if="user_group === '管理员' || (form['enterprise_users_id'] && $check_field('set','user_gender')) || (!form['enterprise_users_id'] && $check_field('add','user_gender'))"
                ></uni-data-select>
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_age') || $check_field('add','user_age') || $check_field('set','user_age')" label="用户年龄" name="user_age">
                                <uni-easyinput type="text" v-model="form['user_age']" v-if="user_group === '管理员' || (form['enterprise_users_id'] && $check_field('set','user_age')) || (!form['enterprise_users_id'] && $check_field('add','user_age'))" :disabled="disabledObj['user_age_isDisabled']" />
                <!-- 仅查看 -->
...
export default {
  ...
  data() {
    return {
      ...
      url_add: "~/api/enterprise_users/add?",
      url_set: "~/api/enterprise_users/set?",
      url_get_obj: "~/api/enterprise_users/get_obj?",
      url_upload: "~/api/enterprise_users/upload?",

      query: {
        "enterprise_users_id": 0,
      },
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/enterprise_users/upload?'),
