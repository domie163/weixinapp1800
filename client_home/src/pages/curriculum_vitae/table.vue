<template>
  <view class="page_curriculum_vitae diy_table diy_table_tml" id="curriculum_vitae_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/curriculum_vitae/view?" v-show="user_group == '管理员' || $check_action('/curriculum_vitae/table','add') || $check_action('/curriculum_vitae/view','add')">添加</navigator>
                            ...
                            <span>个人学历</span>
								...
								<text>
									{{ o["personal_education"] }}
													...
													<view v-if="0 && $check_field('get','graduation_college')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>毕业学院</span>
                          </view>
								...
								<text>
									{{ o["graduation_college"] }}
													...
													<view v-if="0 && $check_field('get','personal_specialty')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>个人特长</span>
                          </view>
                            ...
                            <span>联系方式</span>
								...
								<text>
									{{ o["contact_information"] }}
													...
													<view v-if="0 && $check_field('get','job_position')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>求职岗位</span>
                          </view>
								...
								<text>
									{{ o["job_position"] }}
													...
													<view v-if="0 && $check_field('get','work_experience')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>工作经历</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/curriculum_vitae/table','del') || $check_action('/curriculum_vitae/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/curriculum_vitae/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/curriculum_vitae/table','set') || $check_action('/curriculum_vitae/view','set') || $check_action('/curriculum_vitae/view','get')" class="btn btn-primary">详情</navigator>
	    					</view>
				</view>
			</view>
		</view>
