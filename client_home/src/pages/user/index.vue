					...
					<view>
						<view class="">
							<view  class="list_module">
									<view v-if="user_group != '管理员' && $check_action('/individual_users/table','get')">
									<navigator class="my_module" url="/pages/individual_users/table" hover-class="hover">
										<div>
											<text>个人用户</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/enterprise_users/table','get')">
									<navigator class="my_module" url="/pages/enterprise_users/table" hover-class="hover">
										<div>
											<text>企业用户</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/recruitment_information/table','get')">
									<navigator class="my_module" url="/pages/recruitment_information/table" hover-class="hover">
										<div>
											<text>招聘信息</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/job_information/table','get')">
									<navigator class="my_module" url="/pages/job_information/table" hover-class="hover">
										<div>
											<text>求职信息</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/resume_information/table','get')">
									<navigator class="my_module" url="/pages/resume_information/table" hover-class="hover">
										<div>
											<text>简历信息</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/curriculum_vitae/table','get')">
									<navigator class="my_module" url="/pages/curriculum_vitae/table" hover-class="hover">
										<div>
											<text>个人简历</text>
											<span>></span>
										</div>
