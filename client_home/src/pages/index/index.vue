<template>
  <view id="home" class="home--new">
    ...
    <Card
      class="list_diy"
      title="招聘信息推荐"
      url="/pages/recruitment_information/list"
      :list="list_article"
      v-if="$check_action('/recruitment_information/list', 'get')"
    >
	  <list_recruitment_information :list="list_recruitment_information"></list_recruitment_information>
		...
		*/
		get_recruitment_information() {
			...
			this.$get(url, {
					...
					console.log("招聘信息" ,json.result.list);
