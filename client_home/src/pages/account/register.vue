						...
						<view class="register_view">
							<uni-forms class="form_register" :rules="rules" :value="form" ref="form"
								...
								<uni-forms-item class="user_group" name="user_group" label="身份">
									...
									<!-- 个人用户 -->
								<form_individual_users v-if="form.user_group === '个人用户'" @change="handleSubFormChange" :form="form_sub" ></form_individual_users>
...
<script>
	import mixin from "@/libs/mixins/page.js"
		/* 个人用户 */
	import form_individual_users from "@/components/diy/form_individual_users";
							
	export default {
		components: {
				/* 个人用户 */
			form_individual_users,
								},
		mixins: [mixin],
		data() {
			return {
