<template>
	<view class="page_recruitment_information diy_list diy_list_page div_list_tml" id="recruitment_information_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
														<uni-search-bar placeholder="搜索企业名称" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'enterprise_name')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索招聘岗位" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'recruitment_position')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																		<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?recruitment_information_id=' + o['recruitment_information_id']" class="btn btn-primary">查看详情</navigator>
